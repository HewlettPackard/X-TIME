...
class FDBuilder(DatasetBuilder):
    ...
    def _build_default_dataset(self, **kwargs) -> Dataset:
        ...
        #]
        features = [
            Feature(col, FeatureType.BINARY if col == 'targets' else FeatureType.CONTINUOUS, cardinality=int(train_df[col].nunique())) 
    ...
    def _clean_dataset(self) -> None:
        ...
        # Dataset provides a single file in `fraud_detection_bank_dataset.csv.csv` format
