...
(
  ...
  output wire [C_ADDR_WIDTH-1:0]      awaddr,       // 9
  output wire [7:0]                   awlen,
  output wire [2:0]                   awsize,
  output wire                         awvalid,
  input wire                          awready,

  output wire [C_DATA_WIDTH-1:0]      wdata,        // 14
  output wire [C_DATA_WIDTH/8-1:0]    wstrb,
  output wire                         wlast,
  output wire                         wvalid,
  input wire                          wready,

  input wire [1:0]                    bresp,        // 19
  input wire                          bvalid,
  output wire                         bready
);
...
// Variables
/////////////////////////////////////////////////////////////////////////////
logic [LP_TRANSACTION_CNTR_WIDTH-1:0] num_full_bursts;                      // 22
...
logic                                 wxfer;       // Unregistered write data transfer // 29
logic                                 wfirst = 1'b1;
...
ila_2 i_ila_2 (
    ...
    .probe22(num_full_bursts),
    .probe23(num_partial_bursts),
    .probe24(start),
    .probe25(num_transactions),
    .probe26(has_partial_burst),
    .probe27(final_burst_len),
    .probe28(single_transaction),

    .probe29(wxfer),       
    .probe30(wfirst),
    .probe31(load_burst_cntr),
    .probe32(wxfers_to_go),  
    .probe33(w_transactions_to_go),
    .probe34(w_final_transaction),
    .probe35(w_almost_final_transaction),

    .probe36(awxfer),
    .probe37(awvalid_r),
    .probe38(addr),
    .probe39(wfirst_d1),
    .probe40(wfirst_pulse),
    .probe41(dbg_w_to_aw_outstanding),
    .probe42(idle_aw),
    .probe43(aw_transactions_to_go),
    .probe44(aw_final_transaction),

    .probe45(bxfer),
    .probe46(b_transactions_to_go),
    .probe47(b_final_transaction)
);
