...
OPT_LEVEL ?= -O0 -g
#FREQS ?= --kernel_frequency "0:50|1:50"

CXXFLAGS += -I$(XILINX_XRT)/include -I$(XILINX_VIVADO)/include -Wall $(OPT_LEVEL) -std=c++1y -fopenmp
...
# Building kernel
#$(BUILD_DIR)/vadd.xclbin: ila_proj.xo
$(BUILD_DIR)/vadd.xclbin: $(TEMP_DIR)/vadd.xo
	mkdir -p $(BUILD_DIR)
	v++ -l $(VPP_FLAGS) -t $(TARGET) --platform $(PLATFORM) $(VPP_LDFLAGS) --temp_dir $(TEMP_DIR) $(VPP_LDFLAGS_vadd) -o'$(LINK_OUTPUT)' $(FREQS) $(+)
